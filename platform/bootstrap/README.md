...
| applicationSet | object | `{"applications":{"argocd":{"destination":{"namespace":"argocd","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"argocd","valueFiles":["values.yaml","values/local.yaml"]},"path":"platform/argocd","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"argocd","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}},"external-secrets":{"destination":{"namespace":"external-secrets","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"external-secrets","valueFiles":["values.yaml","values/local.yaml"]},"path":"platform/external-secrets","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"platform-operators","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}},"gateway":{"destination":{"namespace":"envoy-gateway-system","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"envoy-gateway","valueFiles":["values.yaml"]},"path":"platform/gateway","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"gateway","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}},"reloader":{"destination":{"namespace":"reloader","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"reloader","valueFiles":["values.yaml"]},"path":"platform/reloader","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"platform-operators","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}}},"name":"platform","stageLabelKey":"platform-bootstrap-stage","stages":["gateway","argocd","platform-operators"],"syncPolicy":{"applicationsSync":"sync","preserveResourcesOnDeletion":false},"template":{"destination":{"namespace":"argocd","server":"https://kubernetes.default.svc"},"project":"platform"}}` | applicationSet configures generated Applications and their RollingSync order. |
| applicationSet.applications | object | `{"argocd":{"destination":{"namespace":"argocd","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"argocd","valueFiles":["values.yaml","values/local.yaml"]},"path":"platform/argocd","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"argocd","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}},"external-secrets":{"destination":{"namespace":"external-secrets","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"external-secrets","valueFiles":["values.yaml","values/local.yaml"]},"path":"platform/external-secrets","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"platform-operators","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}},"gateway":{"destination":{"namespace":"envoy-gateway-system","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"envoy-gateway","valueFiles":["values.yaml"]},"path":"platform/gateway","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"gateway","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}},"reloader":{"destination":{"namespace":"reloader","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"reloader","valueFiles":["values.yaml"]},"path":"platform/reloader","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"platform-operators","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}}}` | applications maps Application names to complete generated configurations. |
| applicationSet.applications.argocd | object | `{"destination":{"namespace":"argocd","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"argocd","valueFiles":["values.yaml","values/local.yaml"]},"path":"platform/argocd","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"argocd","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}}` | argocd configures the self-managed Argo CD Application. |
...
| applicationSet.applications.external-secrets | object | `{"destination":{"namespace":"external-secrets","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"external-secrets","valueFiles":["values.yaml","values/local.yaml"]},"path":"platform/external-secrets","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"platform-operators","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}}` | external-secrets configures the External Secrets Operator Application. |
| applicationSet.applications.external-secrets.destination | object | `{"namespace":"external-secrets","server":"https://kubernetes.default.svc"}` | destination configures the External Secrets deployment target. |
| applicationSet.applications.external-secrets.destination.namespace | string | `"external-secrets"` | namespace is the External Secrets destination namespace. |
| applicationSet.applications.external-secrets.destination.server | string | `"https://kubernetes.default.svc"` | server is the External Secrets destination cluster API. |
| applicationSet.applications.external-secrets.project | string | `"platform"` | project is the AppProject used by External Secrets. |
| applicationSet.applications.external-secrets.source | object | `{"helm":{"releaseName":"external-secrets","valueFiles":["values.yaml","values/local.yaml"]},"path":"platform/external-secrets","repoURL":"https://github.com/wallchristopher/platform.git"}` | source configures the External Secrets Git and Helm source. |
| applicationSet.applications.external-secrets.source.helm | object | `{"releaseName":"external-secrets","valueFiles":["values.yaml","values/local.yaml"]}` | helm configures the External Secrets Helm release. |
| applicationSet.applications.external-secrets.source.helm.releaseName | string | `"external-secrets"` | releaseName is the External Secrets Helm release name. |
| applicationSet.applications.external-secrets.source.helm.valueFiles | list | `["values.yaml","values/local.yaml"]` | valueFiles lists External Secrets values files relative to its chart. |
| applicationSet.applications.external-secrets.source.path | string | `"platform/external-secrets"` | path is the External Secrets chart path. |
| applicationSet.applications.external-secrets.source.repoURL | string | `"https://github.com/wallchristopher/platform.git"` | repoURL is the External Secrets Git repository. |
| applicationSet.applications.external-secrets.stage | string | `"platform-operators"` | stage assigns External Secrets to its RollingSync health gate. |
| applicationSet.applications.external-secrets.syncPolicy | object | `{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}` | syncPolicy configures External Secrets reconciliation and retry. |
| applicationSet.applications.external-secrets.syncPolicy.automated | object | `{"prune":true,"selfHeal":true}` | automated enables automated External Secrets reconciliation. |
| applicationSet.applications.external-secrets.syncPolicy.automated.prune | bool | `true` | prune removes External Secrets resources deleted from Git. |
| applicationSet.applications.external-secrets.syncPolicy.automated.selfHeal | bool | `true` | selfHeal corrects External Secrets live drift. |
| applicationSet.applications.external-secrets.syncPolicy.retry | object | `{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5}` | retry configures bounded External Secrets sync retries. |
| applicationSet.applications.external-secrets.syncPolicy.retry.backoff | object | `{"duration":"5s","factor":2,"maxDuration":"3m"}` | backoff configures External Secrets retry timing. |
| applicationSet.applications.external-secrets.syncPolicy.retry.backoff.duration | string | `"5s"` | duration is the initial External Secrets retry delay. |
| applicationSet.applications.external-secrets.syncPolicy.retry.backoff.factor | int | `2` | factor multiplies each External Secrets retry delay. |
| applicationSet.applications.external-secrets.syncPolicy.retry.backoff.maxDuration | string | `"3m"` | maxDuration caps the External Secrets retry delay. |
| applicationSet.applications.external-secrets.syncPolicy.retry.limit | int | `5` | limit is the maximum External Secrets retry count. |
| applicationSet.applications.external-secrets.syncPolicy.syncOptions | list | `["CreateNamespace=true","ServerSideApply=true"]` | syncOptions lists External Secrets synchronization options. |
| applicationSet.applications.gateway | object | `{"destination":{"namespace":"envoy-gateway-system","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"envoy-gateway","valueFiles":["values.yaml"]},"path":"platform/gateway","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"gateway","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}}` | gateway configures the Envoy Gateway Application. |
...
| applicationSet.applications.reloader | object | `{"destination":{"namespace":"reloader","server":"https://kubernetes.default.svc"},"project":"platform","source":{"helm":{"releaseName":"reloader","valueFiles":["values.yaml"]},"path":"platform/reloader","repoURL":"https://github.com/wallchristopher/platform.git"},"stage":"platform-operators","syncPolicy":{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}}` | reloader configures the Stakater Reloader Application. |
| applicationSet.applications.reloader.destination | object | `{"namespace":"reloader","server":"https://kubernetes.default.svc"}` | destination configures the Reloader deployment target. |
| applicationSet.applications.reloader.destination.namespace | string | `"reloader"` | namespace is the Reloader destination namespace. |
| applicationSet.applications.reloader.destination.server | string | `"https://kubernetes.default.svc"` | server is the Reloader destination cluster API. |
| applicationSet.applications.reloader.project | string | `"platform"` | project is the AppProject used by Reloader. |
| applicationSet.applications.reloader.source | object | `{"helm":{"releaseName":"reloader","valueFiles":["values.yaml"]},"path":"platform/reloader","repoURL":"https://github.com/wallchristopher/platform.git"}` | source configures the Reloader Git and Helm source. |
| applicationSet.applications.reloader.source.helm | object | `{"releaseName":"reloader","valueFiles":["values.yaml"]}` | helm configures the Reloader Helm release. |
| applicationSet.applications.reloader.source.helm.releaseName | string | `"reloader"` | releaseName is the Reloader Helm release name. |
| applicationSet.applications.reloader.source.helm.valueFiles | list | `["values.yaml"]` | valueFiles lists Reloader values files relative to its chart. |
| applicationSet.applications.reloader.source.path | string | `"platform/reloader"` | path is the Reloader chart path. |
| applicationSet.applications.reloader.source.repoURL | string | `"https://github.com/wallchristopher/platform.git"` | repoURL is the Reloader Git repository. |
| applicationSet.applications.reloader.stage | string | `"platform-operators"` | stage assigns Reloader to its RollingSync health gate. |
| applicationSet.applications.reloader.syncPolicy | object | `{"automated":{"prune":true,"selfHeal":true},"retry":{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5},"syncOptions":["CreateNamespace=true","ServerSideApply=true"]}` | syncPolicy configures Reloader reconciliation and retry. |
| applicationSet.applications.reloader.syncPolicy.automated | object | `{"prune":true,"selfHeal":true}` | automated enables automated Reloader reconciliation. |
| applicationSet.applications.reloader.syncPolicy.automated.prune | bool | `true` | prune removes Reloader resources deleted from Git. |
| applicationSet.applications.reloader.syncPolicy.automated.selfHeal | bool | `true` | selfHeal corrects Reloader live drift. |
| applicationSet.applications.reloader.syncPolicy.retry | object | `{"backoff":{"duration":"5s","factor":2,"maxDuration":"3m"},"limit":5}` | retry configures bounded Reloader sync retries. |
| applicationSet.applications.reloader.syncPolicy.retry.backoff | object | `{"duration":"5s","factor":2,"maxDuration":"3m"}` | backoff configures Reloader retry timing. |
| applicationSet.applications.reloader.syncPolicy.retry.backoff.duration | string | `"5s"` | duration is the initial Reloader retry delay. |
| applicationSet.applications.reloader.syncPolicy.retry.backoff.factor | int | `2` | factor multiplies each Reloader retry delay. |
| applicationSet.applications.reloader.syncPolicy.retry.backoff.maxDuration | string | `"3m"` | maxDuration caps the Reloader retry delay. |
| applicationSet.applications.reloader.syncPolicy.retry.limit | int | `5` | limit is the maximum Reloader retry count. |
| applicationSet.applications.reloader.syncPolicy.syncOptions | list | `["CreateNamespace=true","ServerSideApply=true"]` | syncOptions lists Reloader synchronization options. |
...
| applicationSet.stages | list | `["gateway","argocd","platform-operators"]` | stages orders generated Applications by required health gate. |
